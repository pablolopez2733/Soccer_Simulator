...
spi_ranks = pd.read_csv(f"{wd}Soccer_Sim_V2/data/soccer-spi/spi_global_rankings.csv")
matches = pd.read_csv(f"{wd}Soccer_Sim_V2/data/soccer-spi/spi_matches_latest.csv")
abb = pd.read_csv(f"{wd}Soccer_Sim_V2/data/abb.csv")
valor_merc = pd.read_csv(f"{wd}Soccer_Sim_V2/data/val_merc.csv")
...
teams = teams.merge(valor_merc,left_on='name', right_on='name')
...
tdy = str(date.today()).replace("-", "_")
teams.to_csv(f"{wd}Soccer_Sim_V2/outputs/team_clusters_{tdy}.csv", index = False)
